...
# use ImageGenerator for auto-classification step
...
train_generator = train_datagen.flow_from_directory(
    ...
    target_size=(300,300), # All images will be resized to 150x150 or 300x300
    batch_size=128,
...
path = '/tmp/horse-or-human/humans'
